...
const PenddingDeliveryWindow = () => {
  return (
    <>
      <PlainText2>Pending Delivery Window</PlainText2>
      <WarehouseFilter />
      <StockTablle />
    </>
  );
...
export default PenddingDeliveryWindow;

function StockTablle() {
  return (
    <CardContainer>
      <HeaderName Padding="0px">Pending Delivery List</HeaderName>
      <Table
        striped
        responsive
        bordered
