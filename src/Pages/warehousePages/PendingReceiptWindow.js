...
const PendingReceiptWindow = () => {
  return (
    <>
      <PlainText2>Pending Receipt Window</PlainText2>
      <WarehouseFilter />
      <StockTablle />
    </>
  );
...
export default PendingReceiptWindow;

function StockTablle() {
  return (
    <CardContainer>
      <HeaderName Padding="0px">Pending Receipt List</HeaderName>
      <Table
        striped
        responsive
        bordered
